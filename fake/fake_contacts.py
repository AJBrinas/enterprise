...
for i in range(1, 100):
    ...
    insert_query = f"""INSERT INTO emergency_contacts (contact_name, relationship, contact_number, person_info, created_at)
                   VALUES ('{contact_name}', '{relationship}', '{contact_number}', {person_info}, '{created_at}');"""
